const model = (weather, forecast, warning) => {
    ...
    const updateWarnings = () => warning
    .slice(0, 5)

    const all = () => model(weather, forecast, warning)

    return { addWeatherData, Weather, Forecast, CityWeatherData, filterWeatherDate, filterForecastDate, TimeWeatherData, latestMeasurement, minTemp, maxTemp, totalPrecipitation, avgWindspeed, hourlyPrediction, updateModel, updateLatest, updateWarnings, all }
}
